...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getAllProducts(
        ...
        ProductResponse productResponse = service.getAllProducts(pageNumber, pageSize, sortBy, sortOrder, keyword, category);
    ...
    public ResponseEntity<ProductResponse> getProductCategory(@PathVariable Long categoryId,
      ...
      @RequestParam(name = "sortBy" , defaultValue = AppConstants.SORT_PRODUCTS_BY, required = false) String sortBy,
      @RequestParam(name = "sortOrder" , defaultValue = AppConstants.SORT_DIR, required = false) String sortOrder){
        ProductResponse productResponse = service.searchByCategory(categoryId,pageNumber, pageSize, sortBy, sortOrder);
        return new ResponseEntity<>(productResponse, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ProductResponse> getProductsByKeyword(@PathVariable String keyword,
            ...
            @RequestParam(name = "sortBy" , defaultValue = AppConstants.SORT_PRODUCTS_BY, required = false) String sortBy,
            @RequestParam(name = "sortOrder" , defaultValue = AppConstants.SORT_DIR, required = false) String sortOrder                                                      ){
        ProductResponse productResponse = service.searchProductByKeyword(keyword,pageNumber, pageSize, sortBy, sortOrder);
